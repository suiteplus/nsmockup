 ...
 * @constructor
 */
exports.nlobjError = function nlobjError(code, error, details) {
    this.id = null;
    this.code = code;
    this.details = error;
    this.stacktrace = details instanceof Error ? details : this;
    this.suppressnotification = details;
    if (code instanceof nlobjError/* || code instanceof NLXMLResponseError*/) {
        ...
        if (code instanceof nlobjError) {
            this.stacktrace = code.stacktrace;
        }
    }
    this.name = this.code;
